...
## Basic Build Instructions
  ...
  1. Download Lazarus 2.2.6 from https://sourceforge.net/projects/lazarus/files/Lazarus%20Windows%2064%20bits/Lazarus%202.2.6/ First install lazarus-2.2.6-fpc-3.2.2-win64.exe and then lazarus-2.2.6-fpc-3.2.2-cross-i386-win32-win64.exe
